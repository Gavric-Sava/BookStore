...
class SinglePageRouter extends BaseRouter
{
    ...
    private const REQUEST_BOOK = '/^\/spa\/books(?:\/.*)*$/';
    ...
    public function route(string $request_path): void {
        ...
        if (preg_match(SinglePageRouter::REQUEST_AUTHOR, $request_path)) {
        ...
        } elseif (preg_match(SinglePageRouter::REQUEST_BOOK, $request_path)) {
            // TODO dependency waterfall
